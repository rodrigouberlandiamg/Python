...
# 10 caixas. Para agilizar o cálculo de quanto cada cliente deve pagar ele desenvolveu um
# tabela que contém o número de itens que o cliente comprou e ao lado o valor da conta.
