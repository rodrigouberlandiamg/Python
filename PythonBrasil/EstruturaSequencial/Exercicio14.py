...
peso = float(input('Entre com o peso do peixe KG: '))
excesso = peso - 50
multa = excesso * 4.0
if peso > 50:
    print(f'Peso do peixe é de {peso} e passou {excesso} Kg deverá ser pago multa de R${multa}.')
else:
    print(f'Peso do peixe é de {peso} e não tem multa a ser paga.')